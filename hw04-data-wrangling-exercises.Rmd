...
These joins can be interpretted as "left join = keep all the rows from the left table, adding NA as necessary". It's important to note that the results of left_join(x,y) will not match right_join(x,y), but that left_join(x,y) will match right_join(y, x).
